...
# Filter the DataFrame for rows where customer_ID contains the specific substring
  filtered_df <- df_2[grepl("009b4f146ac20c9e528e23137b3fbef84856f327124ade", customer_ID)]
  ...
  calculate_stats <- function(data) {
    ...
    stats$Percent_NA <- round((stats$Num_NA / total_rows) * 100)
  ...
  # Calculate stats
  column_stats <- calculate_stats(df_2)
